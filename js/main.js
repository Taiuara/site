...
document.addEventListener('DOMContentLoaded', function() {
    const animateElements = document.querySelectorAll('.diferencial-item, .step, .servico-card, .plano-card, .contato-item');
...
function preloadImages() {
    const criticalImages = [
        'images/pingdesk-logo.png',
        'images/pingdesk-hero.png'
    ];
